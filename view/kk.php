            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" placeholder="Keterangan" id="keterangan" name="keterangan"></input>
                        <label for="floatingTextarea">Keterangan</label>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" onclick="clearData()" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
...
<!-- Table -->
    <div class="container-fluid mt-5 pb-5" style="position: relative !important; top: 10%; !important width: 100% !important;">
        ...
        <div class="bg-light rounded mt-2 text-center p-2"> 
            <table class="table table-striped table-hover dtabel text-center" id="tableData" with="100%">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>No Pelayan</th>
