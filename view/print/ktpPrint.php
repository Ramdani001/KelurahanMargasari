...
<div id="libInp" style="display:none">
    <div id=halaman>
        <h3 id=judul>SURAT PENGAJUAN KTP</h3>
        ...
        <p>Mengajukan Permohonan Pelayanan KTP Dengan Nomor Pelayanan <b id="noPelayananPrint"></b> dengan Keterangan <div id="keteranganPrint"></div> </p>
