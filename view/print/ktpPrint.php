...
<div id="libInp" style="display:none">
    <div id=halaman style="text-align:">
        <h3 id=judul style="text-align: center;">SURAT PERMOHONAN KARTU TANDA PENDUDUK (KTP)</h3>
        ...
        <p>Mengajukan Permohonan Pelayanan KTP Dengan Nomor Pelayanan <b id="noPelayananPrint"></b></p>
        <br>
        <br>
        <br>
