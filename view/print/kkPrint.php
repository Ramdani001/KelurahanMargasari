...
<div id="libInp" style="display:none">
    <div id=halaman>
        <h3 id=judul>SURAT PENGAJUAN PELAYANAN KARTU KELUARGA</h3>
        ...
        <p>Mengajukan Permohonan Pelayanan KARTU KELUARGA Dengan Nomor Pelayanan <b id="noPelayananPrint"></b> dengan Keterangan <div id="keteranganPrint"></div> </p>
