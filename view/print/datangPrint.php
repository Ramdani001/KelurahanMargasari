...
<div id="libInp" style="display:none">
    <div id=halaman>
        <h3 id=judul>SURAT PENGAJUAN DATANG</h3>
        ...
        <p>Mengajukan Permohonan pengantar KEDATANGAN DOMISILI Dengan Nomor Pelayanan <b id="noPelayananPrint"></b> dengan Keterangan <div id="keteranganPrint"></div> </p>
