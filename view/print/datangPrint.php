...
<div id=halaman style="text-align:">
        <h3 id=judul style="text-align: center;">SURAT PENGAJUAN DATANG</h3>
        ...
        <p>Mengajukan Permohonan Pelayanan Pengajuan Datang Dengan Nomor Pelayanan <b id="noPelayananPrint"></b></p>
        <br>
        <br>
        <br>
