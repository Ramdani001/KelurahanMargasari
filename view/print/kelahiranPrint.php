...
<div id="libInp" style="display:none">
    <div id=halaman>
        <h3 id=judul>SURAT PENGANTAR PEMBERITAHUAN KELAHIRAN</h3>
        ...
        <p>Mengajukan Permohonan Pelayanan DATA KELAHIRAN Dengan Nomor Pelayanan <b id="noPelayananPrint"></b> dengan Keterangan <div id="keteranganPrint"></div> </p>
