...
<div id=halaman style="text-align:">
        <h3 id=judul style="text-align: center;">SURAT PERMOHONAN KARTU AKTA KELAHIRAN (AKTA)</h3>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="width: 5%;">:</td>
                <td style="width: 75%;"> Pelayanan Akta Kelahiran </td>
            </tr>
            <tr>
                <td><br></td>
            </tr>
        ...
        <p>Mengajukan Permohonan Pelayanan AKTA Kelahiran Dengan Nomor Pelayanan <b id="noPelayananPrint"></b></p>
        <br>
        <br>
        <br>
